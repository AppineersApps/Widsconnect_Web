 ...
 * 
 * @path application\admin\education\controllers\Cit_Education_management.php
 * 
 * @author CIT Dev Team
 * 
 * @date 01.10.2019
...
Class Cit_Education_management extends Education_management {
...
public function checkUniqueInterest($value = ''){
    ...
    if(false == empty($value)){
      ...
      $this->db->from('users');
      $this->db->where('vEducation', $value);
...
{     
        $url = $this->general->getAdminEncodeURL('education/education_management/add').'|mode|'.$this->general->getAdminEncodeURL('Update').'|id|'.$this->general->getAdminEncodeURL($arr);
