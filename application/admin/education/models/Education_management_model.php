 ...
 *
 * @class Education_management_model.php
 *
 * @path application\admin\education\models\Education_management_model.php
 *
 * @version 4.4
 *
 * @author CIT Dev Team
...
class Education_management_model extends CI_Model
{
    public $table_name;
    public $table_alias;
    public $primary_key;
    ...
    public function __construct()
    {
        ...
        $this->table_name = "education";
        $this->table_alias = "i";
        $this->primary_key = "iEducationId";
        $this->primary_alias = "i_education_id";
    ...
    public function insert($data = array())
    {
        ...
        if($insert_id > 0)
        {
            ...
            $logArray['vEntityName'] = "Education- ".$data['vEducationName'];
    ...
    public function getData($extra_cond = "", $fields = "", $order_by = "", $group_by = "", $limit = "", $join = "No", $having_cond = '', $list = FALSE)
    {
        ...
        elseif ($list == TRUE)
        {
            ...
            $this->db->select("i.iEducationId AS i_education_id");
        ...
        {
            $this->db->select("i.iEducationId AS iEducationId");
            $this->db->select("i.iEducationId AS i_education_id");
    ...
    public function getListConfiguration($name = "")
    {
        $list_config = array(
            "education_id" => array(
                ...
                "table_alias" => "i",
                "field_name" => "iEducationId",
                "source_field" => "i_education_id",
                "display_query" => "i.iEducationId",
                "entry_type" => "Table",
                "data_type" => "int",
                "show_in" => "Both",
                "type" => "dropdown",
            ...
            "i_education_name" => array(
                ...
                "table_name" => "education",
                "table_alias" => "i",
                "field_name" => "vEducationName",
                "source_field" => "i_education_name",
                "display_query" => "i.vEducationName",
                "entry_type" => "Table",
                "data_type" => "varchar",
                "show_input" => "Both",
                "type" => "textbox",
                "label" => "Education Name",
                "lang_code" => "EDUCATION_MANAGEMENT_NAME",
                "label_lang" => $this->lang->line('EDUCATION_MANAGEMENT_NAME'),
                "width" => 50,
            ),
            ...
            "i_added_at" => array(
                ...
                "align" => "left",
                "label" => "Created On",
                "lang_code" => "EDUCATION_MANAGEMENT_ADDED_AT",
                "label_lang" => $this->lang->line('EDUCATION_MANAGEMENT_ADDED_AT'),
                "width" => 50,
                "search" => "Yes",
                "export" => "Yes",
                "sortable" => "Yes",
            ...
            "sys_custom_field_1" => array(
                ...
                "align" => "center",
                "label" => "Edit",
                "lang_code" => "EDUCATION_MANAGEMENT_EDIT",
                "label_lang" => "Edit",
                "width" => 50,
                "search" => "No",
                "export" => "No",
