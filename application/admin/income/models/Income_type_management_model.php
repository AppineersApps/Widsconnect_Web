 ...
 *
 * @class income_type_management_model.php
 *
 * @path application\admin\income\models\income_type_management_model.php
 *
 * @version 4.4
 *
 * @author CIT Dev Team
...
class Income_type_management_model extends CI_Model
{
    public $table_name;
    public $table_alias;
    public $primary_key;
    ...
    public function __construct()
    {
        ...
        $this->table_name = "income_types";
        $this->table_alias = "i";
        $this->primary_key = "iIncomeTypeId";
        $this->primary_alias = "i_income_type_id";
    ...
    public function insert($data = array())
    {
        ...
        if($insert_id > 0)
        {
            ...
            $logArray['vEntityName'] = "Income Type - ".$data['vIncomeTypeName'];
    ...
    public function getData($extra_cond = "", $fields = "", $order_by = "", $group_by = "", $limit = "", $join = "No", $having_cond = '', $list = FALSE)
    {
        ...
        elseif ($list == TRUE)
        {
            ...
            $this->db->select("i.iIncomeTypeId AS i_income_type_id");
            $this->db->select("i.vIncomeTypeName AS i_income_type_name");
         //   $this->db->select("i.vEducationImage AS i_education_image");
            $this->db->select("i.eStatus AS i_income_type_status");
            $this->db->select("i.dtAddedAt AS i_added_at");
            $this->db->select("('view') AS sys_custom_field_1", FALSE);
        }
        else
        {
            $this->db->select("i.iIncomeTypeId AS iIncomeTypeId");
            $this->db->select("i.iIncomeTypeId AS i_income_type_id");
    ...
    public function getListConfiguration($name = "")
    {
        $list_config = array(
            "income_type_id" => array(
                "name" => "i_income_type_id",
                "table_name" => "income_types",
                "table_alias" => "i",
                "field_name" => "iIncomeTypeId",
                "source_field" => "i_income_type_id",
                "display_query" => "i.iIncomeTypeId",
                "entry_type" => "Table",
                "data_type" => "int",
                "show_in" => "Both",
                "type" => "dropdown",
                ...
                "lang_code" => "Income Type Id",
                "label_lang" =>"Income Type Id",
                "width" => 50,
                "search" => "Yes",
                "export" => "Yes",
                "sortable" => "Yes",
            ...
            "i_income_type_name" => array(
                "name" => "i_income_type_name",
                "table_name" => "income_types",
                "table_alias" => "i",
                "field_name" => "vIncomeTypeName",
                "source_field" => "i_income_type_name",
                "display_query" => "i.vIncomeTypeName",
                "entry_type" => "Table",
                "data_type" => "varchar",
                "show_input" => "Both",
                "type" => "textbox",
                "label" => "Income Type Name",
                "lang_code" => "INCOME_TYPE_MANAGEMENT_NAME",
                "label_lang" => $this->lang->line('INCOME_TYPE_MANAGEMENT_NAME'),
                "width" => 50,
            ),
            "i_income_type_status" => array(
                ...
                "type" => "dropdown",
                "label" => "Status",
                "lang_code" => "INCOME_TYPE_MANAGEMENT_STATUS",
                "label_lang" => $this->lang->line('INCOME_TYPE_MANAGEMENT_STATUS'),
                "width" => 90,
            ),
            "i_added_at" => array(
                "name" => "i_added_at",
                ...
                "align" => "left",
                "label" => "Created On",
                "lang_code" => "INCOME_TYPE_MANAGEMENT_ADDED_AT",
                "label_lang" => $this->lang->line('INCOME_TYPE_MANAGEMENT_ADDED_AT'),
                "width" => 50,
                "search" => "Yes",
                "export" => "Yes",
                "sortable" => "Yes",
            ...
            "sys_custom_field_1" => array(
                ...
                "align" => "center",
                "label" => "Edit",
                "lang_code" => "INCOME_TYPE_MANAGEMENT_EDIT",
                "label_lang" => "Edit",
                "width" => 50,
                "search" => "No",
                "export" => "No",
