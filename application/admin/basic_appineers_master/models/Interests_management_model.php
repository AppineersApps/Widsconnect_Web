...
class Interests_management_model extends CI_Model
{
    public $table_name;
    public $table_alias;
    public $primary_key;
    ...
    public function getData($extra_cond = "", $fields = "", $order_by = "", $group_by = "", $limit = "", $join = "No", $having_cond = '', $list = FALSE)
    {
        ...
        elseif ($list == TRUE)
        {
            ...
            $this->db->select("i.iInterestsId AS i_interests_id");
            $this->db->select("i.vInterestsName AS i_interests_name");
        ...
        {
            $this->db->select("i.iInterestsId AS iInterestsId");
            $this->db->select("i.iInterestsId AS i_interests_id");
    ...
    public function getListConfiguration($name = "")
    {
        $list_config = array(
            "interest_id" => array(
                ...
                "table_alias" => "i",
                "field_name" => "iInterestsId",
                "source_field" => "i_interests_id",
                "display_query" => "i.iInterestsId",
                "entry_type" => "Table",
                "data_type" => "int",
                "show_in" => "Both",
                "type" => "dropdown",
            ...
            "i_interests_name" => array(
                ...
                "table_name" => "interests",
                "table_alias" => "i",
                "field_name" => "vInterestsName",
                "source_field" => "i_interests_name",
                "display_query" => "i.vInterestsName",
                "entry_type" => "Table",
                "data_type" => "varchar",
                "show_input" => "Both",
                "type" => "textbox",
                "label" => "First Name",
                "lang_code" => "INTERESTS_MANAGEMENT_NAME",
                "label_lang" => $this->lang->line('INTERESTS_MANAGEMENT_NAME'),
                "width" => 50,
            ),
            /*"i_interests_image" => array(
                ...
                "lang_code" => "INTERESTS_MANAGEMENT_IMAGE",
                "label_lang" => $this->lang->line('INTERESTS_MANAGEMENT_IMAGE'),
                "width" => 50,
                "search" => "Yes",
                "export" => "Yes",
                "sortable" => "Yes",
            ...
            "i_interests_status" => array(
                ...
                "type" => "dropdown",
                "label" => "Status",
                "lang_code" => "INTERESTS_MANAGEMENT_STATUS",
                "label_lang" => $this->lang->line('INTERESTS_MANAGEMENT_STATUS'),
                "width" => 90,
            ),
            "i_added_at" => array(
                "name" => "i_added_at",
                ...
                "align" => "left",
                "label" => "Created On",
                "lang_code" => "INTERESTS_MANAGEMENT_ADDED_AT",
                "label_lang" => $this->lang->line('INTERESTS_MANAGEMENT_ADDED_AT'),
                "width" => 50,
                "search" => "Yes",
                "export" => "Yes",
                "sortable" => "Yes",
            ...
            "sys_custom_field_1" => array(
                ...
                "align" => "center",
                "label" => "Edit",
                "lang_code" => "INTERESTS_MANAGEMENT_EDIT",
                "label_lang" => "Edit",
                "width" => 50,
                "search" => "No",
                "export" => "No",
