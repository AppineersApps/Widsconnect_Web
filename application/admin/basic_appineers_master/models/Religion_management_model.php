...
class Religion_management_model extends CI_Model
{
    public $table_name;
    public $table_alias;
    public $primary_key;
    ...
    public function __construct()
    {
        ...
        $this->table_name = "religion";
        $this->table_alias = "i";
        $this->primary_key = "iReligionId";
        $this->primary_alias = "i_religion_id";
    ...
    public function getData($extra_cond = "", $fields = "", $order_by = "", $group_by = "", $limit = "", $join = "No", $having_cond = '', $list = FALSE)
    {
        ...
        elseif ($list == TRUE)
        {
            ...
            $this->db->select("i.iReligionId AS i_religion_id");
            $this->db->select("i.vReligionName AS i_religion_name");
         //   $this->db->select("i.vInterestsImage AS i_religion_image");
            $this->db->select("i.eStatus AS i_religion_status");
            $this->db->select("i.dtAddedAt AS i_added_at");
            $this->db->select("('view') AS sys_custom_field_1", FALSE);
        }
        else
        {
            $this->db->select("i.iReligionId AS ireligionId");
            $this->db->select("i.iReligionId AS i_religion_id");
           
            $this->db->select("i.vReligionName AS i_religion_name");
       //      $this->db->select("i.vInterestsImage AS i_interests_image");
    ...
    public function getListConfiguration($name = "")
    {
        $list_config = array(
           /* "religion_id" => array(
                ...
                "table_name" => "religion",
                "table_alias" => "i",
                "field_name" => "iReligionId",
                "source_field" => "i_religion_id",
                "display_query" => "i.iReligionId",
                "entry_type" => "Table",
                "data_type" => "int",
                "show_in" => "Both",
                "type" => "dropdown",
                "align" => "center",
                "label" => "Religion Id",
                "lang_code" => "Religion Id",
                "label_lang" =>"Religion Id",
                "width" => 50,
                "search" => "Yes",
                "export" => "Yes",
                "sortable" => "Yes",
            ...
            "i_religion_name" => array(
                "name" => "i_religion_name",
                "table_name" => "religion",
                "table_alias" => "i",
                "field_name" => "vReligionName",
                "source_field" => "i_religion_name",
                "display_query" => "i.vReligionName",
                "entry_type" => "Table",
                "data_type" => "varchar",
                "show_input" => "Both",
                "type" => "textbox",
                "label" => "Religion Name",
                "lang_code" => "RELIGION_MANAGEMENT_NAME",
                "label_lang" => $this->lang->line('RELIGION_MANAGEMENT_NAME'),
                "width" => 50,
                "search" => "Yes",
                "export" => "Yes",
                "sortable" => "Yes",
            ...
            /*"i_religion_image" => array(
                "name" => "i_religion_image",
                "table_name" => "religion",
                "table_alias" => "i",
                "field_name" => "vInterestsImage",
                "source_field" => "i_religion_image",
                "entry_type" => "Table",
                "data_type" => "varchar",
                "show_input" => "Both",
                "type" => "file",
                "label" => "Interests Image",
                "lang_code" => "RELIGION_MANAGEMENT_IMAGE",
                "label_lang" => $this->lang->line('RELIGION_MANAGEMENT_IMAGE'),
                "width" => 50,
                "search" => "Yes",
                "export" => "Yes",
                "sortable" => "Yes",
                ...
                "file_upload" => "Yes",
                "file_server" => "amazon",
                "file_keep" => "ireligionId",
                "file_folder" => "widsconnect/religion_image",
                "file_width" => "80",
                "file_height" => "80",
            ...
            "i_religion_status" => array(
                ...
                "table_alias" => "i",
                "field_name" => "eStatus",
                "source_field" => "i_religion_status",
                "display_query" => "i.eStatus",
                "entry_type" => "Table",
                "data_type" => "enum",
                "show_input" => "Both",
                "type" => "dropdown",
                "label" => "Status",
                "lang_code" => "RELIGION_MANAGEMENT_STATUS",
                "label_lang" => $this->lang->line('RELIGION_MANAGEMENT_STATUS'),
                "width" => 90,
                 "search" => "Yes",
                "export" => "Yes",
                "sortable" => "Yes",
            ...
            "i_added_at" => array(
                ...
                "align" => "left",
                "label" => "Created On",
                "lang_code" => "RELIGION_MANAGEMENT_ADDED_AT",
                "label_lang" => $this->lang->line('RELIGION_MANAGEMENT_ADDED_AT'),
                "width" => 50,
                "search" => "Yes",
                "export" => "Yes",
                "sortable" => "Yes",
            ...
            "sys_custom_field_1" => array(
                ...
                "align" => "center",
                "label" => "Edit",
                "lang_code" => "RELIGION_MANAGEMENT_EDIT",
                "label_lang" => "Edit",
                "width" => 50,
                "search" => "No",
                "export" => "No",
    ...
    public function getFormConfiguration($name = "")
    {
        $form_config = array(
            ...
            /*"i_interests_image" => array(
                ...
                "file_upload" => "Yes",
                "file_server" => "amazon",
                "file_folder" => "widsconnect/interests_image",
                "file_keep" => "iReligionId",
                "file_width" => "80",
                "file_height" => "80",
                "file_format" => "gif,png,jpg,jpeg,jpe,bmp,ico",
