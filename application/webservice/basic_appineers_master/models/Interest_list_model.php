...
class Interest_list_model extends CI_Model
{
    ...
    /**
     * interest_list method is used to execute database queries for States List API.
    ...
    public function interest_list()
    {
        try {
            ...
            $this->db->select('iInterestsId AS business_type_id');
            $this->db->select('vInterestsName AS business_type_name');
