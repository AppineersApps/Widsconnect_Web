...
class Religion_list extends Cit_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->load->model('religion_type_list_model');
        //Model wali file
    }
     ...
     */
    public function rules_religion_list($request_arr = array())
    {
         $valid_arr = array(            
            "user_id" => array(
                array(
     ...
     */
    public function start_religion_list($request_arr = array(), $inner_api = FALSE)
    {
       //print_r($request_arr);
        ...
        switch ($method) {
        case 'GET':
           $output_response =  $this->get_religion($request_arr);
     ...
     public function get_religion($request_arr)
    {
        //print_r($request_arr);//"religion_id_required
         try
        {
            $validation_res = $this->rules_religion_list($request_arr);
            ...
            $input_params = $this->get_religion_list_v1($input_params);
     ...
     */
    public function get_religion_list_v1($input_params = array())
    {

        $this->block_result = array();
        try
        {
            $this->block_result = $this->religion_type_list_model->religion_type_list();
        ...
        $input_params["get_religion_type_list_v1"] = $this->block_result["data"];
    ...
    public function condition($input_params = array())
    {
        ...
        try
        {
            ...
            $cc_lo_0 = (empty($input_params["get_religion_type_list_v1"]) ? 0 : 1);
            $cc_ro_0 = 1;
    ...
    public function mod_state_finish_success($input_params = array())
    {
       /* print_r($input_params); exit;*/
        $setting_fields = array(
            "success" => "1",
            "message" => "Get religion type list fetched successfully.",
        );
        $output_fields = array(
            'religion_id',
            'religion_name',
        ...
        $func_array["function"]["name"] = "get_religion_type_list_v1";
