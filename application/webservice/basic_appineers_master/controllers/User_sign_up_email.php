            ...
            if ($condition_res["success"])
            {
                ...
                if ($condition_res["success"])
                {
                   ...
                   // print_r($input_params);
                    ...
                    // $input_params['email_confirmation_link'] = $this->CI->config->item('site_url').'confirmation?code='.$input_params['email_confirmation_code'];

                   // echo $input_params['email_confirmation_link']; exit();
