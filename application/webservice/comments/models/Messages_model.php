...
class Messages_model extends CI_Model
{
     ...
     */
    public function check_chat_intiated_or_not($user_id = '', $receiver_id = '', $firebase_id = '', $app_section = '')
    {
        try
        {
            $result_arr = array();
            ...
            if($app_section !="" && $app_section > 0)
            {
                $this->db->where("m.app_section =",$app_section);
            }
